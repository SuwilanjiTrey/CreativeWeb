...
<p align="center">
  <b>Websites · Mobile Apps · ERP Systems · Payments</b><br>
...
<sub>Developers: setup notes, the design system and the current to-do list are in [DEVELOPMENT.md](DEVELOPMENT.md). Release history is in [CHANGELOG.md](CHANGELOG.md).</sub>
